                            ...
                            <tbody>
                                {
                                    (myMerchants.length !== 0)
                                        ? myMerchants.map((merch) => <tr key={merch.id}>{merch.id}</tr>)
                                        : <tr>not ok</tr>
                    ...
                    <Col>
                        ...
                        <Table className="boxed">
                            ...
                            <tbody>
                                {
                                    (eshopsCZ.length !== 0)
                                        ? eshopsCZ.map((eshop) => <tr key={eshop.id}><td>{eshop.data.name}</td><td>{eshop.data.description}</td><td>{eshop.data.url}</td><td><span className="boxed">EDIT</span><span className="boxed">DEL</span></td></tr>)
                                        : <tr>not ok</tr>
